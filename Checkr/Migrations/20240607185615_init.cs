    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserBoards", x => new { x.BoardsId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_UserBoards_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CardContent = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CardImageFileName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ToDoItemContent = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ToDoItems_Cards_CardId",
                        column: x => x.CardId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ToDoItems_CardId",
                table: "ToDoItems",
                column: "CardId");

            migrationBuilder.CreateIndex(
                name: "IX_UserBoards_UsersId",
                table: "UserBoards",
                column: "UsersId");
        }
